...
This skill should **not** end at prompt generation by default.  
It should produce an architecture decision **and** a build-ready implementation plan the user can continue immediately.

Prompt-only output is optional and should be used only when explicitly requested by the user.
